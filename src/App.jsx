...
function AuthScreen({ onAuth }) {
  ...
  const inputStyle = {
    width: "100%", background: "#0a0f2e",
    border: "1px solid #1e3a7a", borderRadius: 12,
    padding: "14px 14px 14px 46px", color: "#fff",
  ...
  return (
    <div style={{
      minHeight: "100vh", background: "radial-gradient(ellipse at 20% 20%, #001a5e 0%, #000510 50%, #000820 100%)",
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      padding: "24px 20px", position: "relative", overflow: "hidden",
    }}>
      {/* Background glow orbs */}
      <div style={{ position: "absolute", top: -100, left: -100, width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle,#1a4fd8 0%,transparent 70%)", opacity: 0.5, pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: -80, right: -80, width: 240, height: 240, borderRadius: "50%", background: "radial-gradient(circle,#0a2a8a 0%,transparent 70%)", opacity: 0.4, pointerEvents: "none" }} />
      <div style={{ position: "absolute", top: 0, right: 0, width: "40%", height: "60%", backgroundImage: "radial-gradient(circle, #1e3a7a22 1px, transparent 1px)", backgroundSize: "20px 20px", pointerEvents: "none" }} />

      {/* Logo */}
      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
        <div style={{ width: 56, height: 56, borderRadius: 16, background: "linear-gradient(135deg,#1a4fd8,#2563eb)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 32px #1a4fd844" }}>
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
            <path d="M13 2L4.5 13.5H12L11 22L19.5 10.5H12L13 2Z" fill="white" stroke="white" strokeWidth="1" strokeLinejoin="round"/>
          </svg>
        </div>
        <div>
          <div style={{ fontWeight: 800, fontSize: 26, letterSpacing: "-.02em" }}>
            <span style={{ color: "#fff" }}>Tez</span>
            <span style={{ color: "#3b82f6" }}>Connect</span>
          </div>
          <div style={{ fontSize: 10, color: "#4a6fa5", fontWeight: 700, letterSpacing: ".15em", textTransform: "uppercase", marginTop: 1 }}>
            B2B Professional Network
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        background: "linear-gradient(145deg,#0d1b4b,#080f2e)",
        border: "1px solid #1e3a7a",
        borderRadius: 24, padding: "32px 28px",
        boxShadow: "0 24px 80px #00000088, 0 0 0 1px #1e3a7a44",
      }}>
        {/* Title */}
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <h1 style={{ fontFamily: "'Instrument Serif',serif", fontStyle: "italic", fontWeight: 400, fontSize: 32, color: "#fff", marginBottom: 8, letterSpacing: "-.01em" }}>
            {mode === "signin" ? "Welcome Back" : mode === "signup" ? "Get Started" : "Reset Password"}
          </h1>
          <p style={{ fontSize: 14, color: "#6b8cc9", lineHeight: 1.5 }}>
            {mode === "signin" ? "Sign in to access your B2B dashboard." :
             mode === "signup" ? "Create your TezConnect account." :
        ...
        {/* Error / Success */}
        {error && (
          <div style={{ background: "#2d0a0a", border: "1px solid #f8717144", borderRadius: 10, padding: "10px 14px", fontSize: 13, color: "#f87171", marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}>
            <span>✕</span> {error}
            <button onClick={() => setError("")} style={{ marginLeft: "auto", background: "none", border: "none", color: "#f87171", cursor: "pointer", fontSize: 16 }}>×</button>
          </div>
        )}
        {success && (
          <div style={{ background: "#0a2d1a", border: "1px solid #22c55e44", borderRadius: 10, padding: "10px 14px", fontSize: 13, color: "#22c55e", marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}>
            <span>✓</span> {success}
          </div>
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {mode === "signup" && (
            <div>
              <label style={{ fontSize: 13, fontWeight: 700, color: "#cbd5e1", display: "block", marginBottom: 8 }}>Full Name</label>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 16, color: "#3b82f6" }}>👤</span>
                <input value={name} onChange={e => setName(e.target.value)} placeholder="Your full name" style={inputStyle}
                  onFocus={e => e.target.style.borderColor = "#3b82f6"}
                  onBlur={e => e.target.style.borderColor = "#1e3a7a"} />
              </div>
            </div>
          )}
          ...
          <div>
            <label style={{ fontSize: 13, fontWeight: 700, color: "#cbd5e1", display: "block", marginBottom: 8 }}>
              {mode === "forgot" ? "Email Address" : "Email Address"}
            </label>
            <div style={{ position: "relative" }}>
              <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 16, color: "#3b82f6" }}>✉️</span>
              <input
                value={email} onChange={e => setEmail(e.target.value)}
                onKeyDown={e => e.key === "Enter" && (mode === "signin" ? handleSignIn() : mode === "signup" ? handleSignUp() : handleForgot())}
                placeholder="you@company.com" type="email" style={inputStyle}
                onFocus={e => e.target.style.borderColor = "#3b82f6"}
                onBlur={e => e.target.style.borderColor = "#1e3a7a"}
              />
            </div>
          ...
          {mode !== "forgot" && (
            <div>
              <label style={{ fontSize: 13, fontWeight: 700, color: "#cbd5e1", display: "block", marginBottom: 8 }}>Password</label>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", fontSize: 16, color: "#3b82f6" }}>🔒</span>
                <input
                  value={password} onChange={e => setPassword(e.target.value)}
                  onKeyDown={e => e.key === "Enter" && (mode === "signin" ? handleSignIn() : handleSignUp())}
                  placeholder="Your password" type={showPass ? "text" : "password"} style={{ ...inputStyle, paddingRight: 46 }}
                  onFocus={e => e.target.style.borderColor = "#3b82f6"}
                  onBlur={e => e.target.style.borderColor = "#1e3a7a"}
                />
                <button onClick={() => setShowPass(s => !s)} style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", fontSize: 16, color: "#4a6fa5" }}>
                  {showPass ? "🙈" : "👁️"}
                </button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
                <div
                  ...
                  style={{ width: 16, height: 16, borderRadius: 4, border: `2px solid ${remember ? "#3b82f6" : "#1e3a7a"}`, background: remember ? "#3b82f6" : "transparent", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all .2s", flexShrink: 0 }}>
                  {remember && <span style={{ color: "#fff", fontSize: 10, fontWeight: 800 }}>✓</span>}
                </div>
                <span style={{ fontSize: 13, color: "#8ba3c9" }}>Remember me</span>
              </label>
              <button onClick={() => { setMode("forgot"); setError(""); setSuccess(""); }}
                style={{ background: "none", border: "none", color: "#3b82f6", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "'Plus Jakarta Sans',sans-serif" }}>
                Forgot Password?
              </button>
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              background: loading ? "#1e3a7a" : "linear-gradient(135deg,#2563eb,#1d4ed8)",
              color: loading ? "#4a6fa5" : "#fff",
              fontSize: 15, fontWeight: 700, cursor: loading ? "wait" : "pointer",
              fontFamily: "'Plus Jakarta Sans',sans-serif",
              boxShadow: loading ? "none" : "0 4px 20px #2563eb66",
              transition: "all .2s",
            }}>
            {loading
              ? (mode === "forgot" ? "Sending…" : "Please wait…")
              : mode === "signin" ? "Sign In"
          ...
          {/* Divider */}
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ flex: 1, height: 1, background: "#1e3a7a" }} />
            <span style={{ fontSize: 12, color: "#4a6fa5", fontWeight: 600 }}>
              {mode === "forgot" ? "OR" : mode === "signin" ? "NEW TO TEZCONNECT?" : "ALREADY HAVE AN ACCOUNT?"}
            </span>
            <div style={{ flex: 1, height: 1, background: "#1e3a7a" }} />
          </div>
          ...
          {mode === "signin" ? (
            <button onClick={() => { setMode("signup"); setError(""); setSuccess(""); }}
              style={{ width: "100%", background: "transparent", border: "1px solid #1e3a7a", borderRadius: 12, padding: "14px", color: "#cbd5e1", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Plus Jakarta Sans',sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all .2s" }}
              onMouseEnter={e => e.currentTarget.style.borderColor = "#3b82f6"}
              onMouseLeave={e => e.currentTarget.style.borderColor = "#1e3a7a"}>
              👤 Create an Account
            </button>
          ) : (
            <button onClick={() => { setMode("signin"); setError(""); setSuccess(""); }}
              style={{ width: "100%", background: "transparent", border: "1px solid #1e3a7a", borderRadius: 12, padding: "14px", color: "#cbd5e1", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "'Plus Jakarta Sans',sans-serif", transition: "all .2s" }}
              onMouseEnter={e => e.currentTarget.style.borderColor = "#3b82f6"}
              onMouseLeave={e => e.currentTarget.style.borderColor = "#1e3a7a"}>
              ← Back to Sign In
            </button>
        ...
        {/* Trust badges */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10, marginTop: 24, paddingTop: 20, borderTop: "1px solid #1e3a7a" }}>
          {[
            { icon: "🛡️", title: "Secure", sub: "Enterprise-grade security" },
            { icon: "👥", title: "Professional", sub: "Connect with verified businesses" },
            { icon: "⚡", title: "Efficient", sub: "Streamline your B2B workflow" },
          ].map(b => (
            <div key={b.title} style={{ textAlign: "center" }}>
              <div style={{ fontSize: 20, marginBottom: 4 }}>{b.icon}</div>
              <div style={{ fontSize: 11, fontWeight: 700, color: "#3b82f6", marginBottom: 2 }}>{b.title}</div>
              <div style={{ fontSize: 9, color: "#4a6fa5", lineHeight: 1.4 }}>{b.sub}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 12, color: "#2a3a5e", marginBottom: 6 }}>© 2024 TezConnect. All rights reserved.</div>
        <div style={{ display: "flex", gap: 14, justifyContent: "center" }}>
          <a href="#" style={{ fontSize: 12, color: "#3b82f6", textDecoration: "none" }}>Privacy Policy</a>
          <span style={{ color: "#2a3a5e" }}>•</span>
          <a href="#" style={{ fontSize: 12, color: "#3b82f6", textDecoration: "none" }}>Terms of Service</a>
        </div>
      </div>
    </div>
  );
